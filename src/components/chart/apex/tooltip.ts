export function tooltipOneLine(label: string, value: string | number, color: string, isDark: boolean) {
  ...
  const border = isDark ? 'rgba(145, 158, 171, 0.2)' : 'rgba(145, 158, 171, 0.15)';
  const shadow = isDark 
...
export function tooltipWithTitle(title: string, label: string, value: string | number, color: string, isDark: boolean) {
  // Extremely tight shadow with maximum negative spread
  const bg = isDark ? 'rgb(33, 43, 54)' : 'rgb(255, 255, 255)';
  const text = isDark ? 'rgb(255, 255, 255)' : 'rgb(33, 43, 54)';
  const titleBg = isDark ? 'rgba(145, 158, 171, 0.15)' : 'rgba(145, 158, 171, 0.1)';
